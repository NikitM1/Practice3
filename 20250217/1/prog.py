...
def read_git_object(repo_path, object_hash):
    ...
    if not os.path.exists(obj_path):
        return f"Object {object_hash} not found"
...
def print_commit_history(repo_path, branch_name):
    ...
    while commit_hash:
        ...
        print(f"Commit {commit_hash} tree:")
        print(read_git_object(repo_path, tree_hash), end='\n\n')
...
if len(sys.argv) == 2:
    ...
    print("Press\n1 to get last commit info\n2 to get last commit tree\n3 to get commits history")
